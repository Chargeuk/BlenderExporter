...
[`../lightmap_tools/LIGHTMAP_PROCESSING.md`](../lightmap_tools/LIGHTMAP_PROCESSING.md)
...
See [`example.environment-build.json`](example.environment-build.json). Paths are
