...
## Chargeuk fork: Blender 5.2 compatibility

The local 3.3.3 update has been tested with Blender 5.2.2 LTS on a static KaDshow environment. See [installation, fixes and reproducible tests](docs/BLENDER_52.md) and [the KaDshow import contract and remaining asset gaps](docs/KADSHOW_EXPORT_GAPS.md). Build the updated add-on with `python tools/package_addon.py`; the older root ZIP is historical.
